...
//	}
	...
	public newJBut(ImageIcon image){
		super(image);
		init();
	}
	...
	protected void paintComponent(Graphics g) {
		...
		if (getModel().isPressed()) {
			...
			p2 = new GradientPaint(0, 1,bottomcolor, 0, h - 3, new Color(155, 155, 155, 100));
		} else {
		...
		g2d.clip(r2d);
		GradientPaint gp = new GradientPaint(0.0F, 0.0F, bottomcolor, 0.0F, h, bottomcolor, true);
		g2d.setPaint(gp);
