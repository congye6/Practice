...
public class PositionDriverModifyUi extends JPanel{
	...
	public PositionDriverModifyUi(final ClientControler mainControler,final ButtonComponents bc){
		super();
...
//		bc.change();
	...
	public void paintComponent(Graphics g) {
		...
		Image img01 = new ImageIcon("graphic/position/background/modify_driver_background1.png").getImage();
