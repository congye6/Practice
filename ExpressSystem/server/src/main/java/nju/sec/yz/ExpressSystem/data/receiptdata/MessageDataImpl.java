...
public class MessageDataImpl extends UnicastRemoteObject implements MessageDataService{
	...
	private List<MessagePO> findAll(){
	...
	@Override
	public synchronized void deleteMessage(String user,String password,String messageId) throws RemoteException {
	...
	@Override
	public void addMessage(String user,String password,MessagePO po) throws RemoteException {
	...
	@Override
	public List<MessagePO> getMessages(String user,String password,String personId) throws RemoteException {
